...
int main(int argc, char **argv) {
  ...
  d.add_options()("help,h", "produce this help message")(
      "output,o", boost::program_options::value<string>(),
      "Output of program \n'list' starlist or \n'trail' for startrail")(
      "latitude,m", boost::program_options::value<float>(),
      "Latitude of location (meridian) in gg.dddddd \nnorth positive, south "
      "negative")("longitude,l", boost::program_options::value<float>(),
                  "Longitude of location in gg.dddddd\n0.0 < Lon < 360.0")(
      "magnitude,v", boost::program_options::value<float>(),
      "minimal magnitude of the stars")("time,t",
                                        boost::program_options::value<float>(),
                                        "set time and date in Julian UTC")(
      "year,Y", boost::program_options::value<int>(),
      "set year")("month,M", boost::program_options::value<int>(), "set month")(
      "day,D", boost::program_options::value<int>(),
      "set day")("hour,H", boost::program_options::value<int>(), "set hour")(
      "min,i", boost::program_options::value<int>(), "set minutes")(
      "sec,s", boost::program_options::value<int>(), "set seconds")(
      "utc,u", boost::program_options::value<double>(),
      "set UTC time")("angle,a", boost::program_options::value<float>(),
                      "angle from zenith for list of visible stars")(
      "star,S", boost::program_options::value<int>(), "set star for startrail")(
      "step,p", boost::program_options::value<int>(), "set number of steps")(
      "exposure,e", boost::program_options::value<double>(),
  ...
  if (m.count("utc")) {
    utime = m["utc"].as<double>();
    timeset = timeset | SETUTC;
  } else {
    time_t now = time(0);
    ltm = *localtime(&now);
  }
